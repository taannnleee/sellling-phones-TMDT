...
function timKiemTheoMa(list, ma) {
    for (var l of list) {
        if (l.productDetailId == ma) return l;
    }
}
...
function addProduct(p, ele, returnString) {
	product = new Product(p.productDetailId, p.name, p.imageUrl, p.price); // Class product
	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="/introduction"><i class="fa fa-info-circle"></i> Giới thiệu</a></li>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="/index">
                <img href="/index" src="../img/logo.jpg" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
