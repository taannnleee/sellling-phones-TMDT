...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Category category1 = Category.builder()
                .urlImage("img/products/iphone-7-plus-32gb-hh-600x600.jpg")
                .categoryName("Apple")
                .status("on")
                .build();
        ...
        Category category2 = Category.builder()
                .urlImage("img/products/samsung-galaxy-s21-600x600.jpg")
                .categoryName("Samsung")
                .status("on")
                .build();
        categoryRepository.save(category2);
        Category category3 = Category.builder()
                .urlImage("img/products/google-pixel-5-600x600.jpg")
                .categoryName("Google")
                .status("on")
                .build();
        ...
        Category category4 = Category.builder()
                .urlImage("img/products/oneplus-9-600x600.jpg")
        ...
        Category category5 = Category.builder()
                .urlImage("img/products/huawei-p40-600x600.jpg")
                .categoryName("Huawei")
                .status("on")
                .build();
        ...
        Category category6 = Category.builder()
                .urlImage("img/products/xiaomi-mi-11-600x600.jpg")
                .categoryName("Xiaomi")
                .status("on")
                .build();
        ...
        Category category7 = Category.builder()
                .urlImage("img/products/oppo-find-x3-600x600.jpg")
                .categoryName("Oppo")
                .status("on")
                .build();
        ...
        Category category8 = Category.builder()
                .urlImage("img/products/sony-xperia-1-600x600.jpg")
                .categoryName("Sony")
                .status("on")
                .build();
        ...
        Category category9 = Category.builder()
                .urlImage("img/products/lg-wing-600x600.jpg")
                .categoryName("LG")
                .status("on")
                .build();
